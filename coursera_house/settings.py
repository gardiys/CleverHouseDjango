...
STATIC_URL = '/static/'
SMART_HOME_ACCESS_TOKEN = os.getenv('SMART_HOME_ACCESS_TOKEN','b95790412e0577f858d8ebf9542e31a885e1212f922c3fc7a2748d96292179c1')
SMART_HOME_API_URL = os.getenv('SMART_HOME_API_URL', 'http://smarthome.t3st.ru/api/user.controller')
EMAIL_HOST = os.getenv('EMAIL_HOST', 'smtp.yandex.ru')
EMAIL_PORT = os.getenv('EMAIL_PORT', 465)
EMAIL_RECEPIENT  = os.getenv('EMAIL_RECEPIENT', 'sherback.anton@gmail.com')
